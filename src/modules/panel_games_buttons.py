...
from src.functions.describe import lucky_number_describe,\
    duel_describe
from src.functions.embeds import embed_games_panel, embed_stats_duel, embed_stats_lucky
from src.modules.config import lucky_number
import src.modules.panel_play_games as ppg
from src.functions.discord import form_lucky_stats_dict, form_duel_stats_dict
